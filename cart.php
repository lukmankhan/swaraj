		...
		$date = date('Y-m-d');
			...
			if(!empty($insertdata))
			{
				...
				//===============================Mail COde================================================
					...
					$emailSubject = 'Order Placed Successfully  '.''.$name;
					$htmlContent = '<h2>Dear '.$name.' your order '.$order_id.' placed successfully</h2>
                    ';
				...
				<div class="col-md-12 ab_pic_w3ls_text_info">
					...
					<div class="table-responsive cart_info">
						...
						<?php
									...
									<!--<a href="address_details.php"  class="btn btn-info mb-2">Order Place</a>-->
					...
					?>
						<tr>
							...
							<h3 style="text-align:center;">Missing Cart items?</h3>
							</td>
						</tr>	
						<?php
							}
