      ...
      <center> <img width=85 height=85 style="" src="<?php echo base_url();?>/assets/images/slogo.png"></center> </td>
          ...
          <!--<p style="margin-left:20px;"><b>Report Run Date :&nbsp;</b><?php echo date('Y-m-d');?></p>-->
           <p style="margin-left:20px;"><b>Report Run Date :&nbsp;</b><?php echo date("d-m-Y", strtotime(date('Y-m-d')));?></p>
			<p style="margin-left:20px;"><b>Report Type  :&nbsp;</b> Vendor Report</p>
...
<table width='90%' align='center' border=1 cellpadding=3>
  <thead>
    <tr>
      ...
      <th style='background-color:#d8d3d3;' >Company Name</th>
      ...
      <th style='background-color:#d8d3d3;' >Commission</th>
      <th style='background-color:#d8d3d3;' >Employee Name</th>
...
<a href="<?php echo site_url('index.php/Home/excel_vendor/'.$from_date.'/'.$to_date.''); ?>"> <input type="button" class="button" style='width: 200px;' value="Export To Excel"> </a>
</div>
...
{
          ?>
			<h3 align=center>Vendor Reports</h3>
