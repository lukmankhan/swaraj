						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-block">
									<h4 class="sub-title">Add Designation</h4>
									<form method="post" action="<?php echo site_url('index.php/Home/add_designation'); ?>" enctype="multipart/form-data">
							   ...
							   <table id="bootstrap-data-table" class="table table-striped table-bordered tfont">
								...
								<tbody>
									...
									<tr class="odd gradeX">
										...
										<td><a href="<?php echo base_url("index.php/Home/designation_edit").'/'.$row['id'].'';?>" class="btn btn-success">Edit</a>
										<a href="<?php echo base_url("index.php/Home/delete_designation").'/'.$row['id'].'';?>" class="btn btn-danger" onclick="return confirm('Are you sure ?');">Delete</a>
										</td>
                                    </tr>
									<?php
										}
