						...
						<div class="col-sm-12">
							<div class="card">
								<div class="card-block">
									<h4 class="sub-title">Update Employee</h4>
									<form method="post" action="<?php echo site_url('index.php/Home/update_emp'); ?>" enctype="multipart/form-data">
										...
										<div class="form-group row">
											...
											<div class="col-sm-4">
												<input type="text" class="form-control" name="username" value="<?php echo $result[0]['username'];?>" readonly>
											</div>
											<label class="col-sm-2 col-form-label">Password</label>
											<div class="col-sm-4">
												<input type="text" class="form-control" name="password" value="<?php echo $result[0]['password'];?>" readonly>
											</div>
										</div>
										<div class="form-group row">
