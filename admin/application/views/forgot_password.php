            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form class="md-float-material" action="<?php echo site_url('index.php/forgot_password/submit_data_forgot_pass');?>" method="post">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
										<input type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" value="Send">
